...
<head>
    ...
    <title>Oakland Games - Pacman</title>
...
<main class="Site-content">
    <div style="text-align: center; color: white">
        <img src="assets/img/banners/gamebanner.svg"  style="height:50vh;width:100%"/>
            ...
            <h1 style="text-align:center; padding-left:30px;">Pacman</h1>
				<aside>Up+down+Left+Right Keyboard Control	</aside>
			<div style="float: left"><a href="game2.php"><h1><- Last game</h1></a></div> <div style="float: right"><a href="game1.php"><h1>Next game -></h1></a></div>
        </div>
    <div align="center">
<embed src="inc/swf/pacman.swf" style="margin: 0 auto; float: none; margin-bottom 10px; padding-top:25px;" width="550" height="400" />
    </div>
