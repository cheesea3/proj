...
<div class="row">
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title" style="color:#F0AD00;">Game 2</h5>
        <p class="card-text" style="color:black">Super fun game|</p>
        <a href="#" class="btn btn-primary">Play</a>
      </div>
    </div>
    ...
    <div class="card">
      <div class="card-body">
        <h5 class="card-title" style="color:#F0AD00;">Game 3</h5>
        <p class="card-text" style="color:black">Super fun game|</p>
        <a href="#" class="btn btn-primary">Play</a>
      </div>
    </div>
    ...
    <div class="container ">
        <div class="row text-center text-xs-center text-sm-left text-md-left">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4">
                <h5>Legal</h5>
                <ul class="list-unstyled quick-links">
                    <li><a href="imprint.php"><i class="fa fa-angle-double-right"></i> Imprint</a></li>
